...
```bash
git clone https://github.com/dhanyamankad/week3-agentx.git
cd week3-agentx
```
...
![Query 1](screenshots/query1_space_news.png)

### Query 2 — Historical Question
![Query 2](screenshots/query2_homi_bhabha.png)

### Query 3 — Both Tools Used
![Query 3](screenshots/query3_isro_both_tools.png)

### Query 4 — Agent Limitation
![Query 4](screenshots/query4_milk_price.png)

### Query 5 — Memory Test ⭐
![Query 5](screenshots/query5_memory_test.png)

### Reasoning Trace Open
![Trace](screenshots/query1_reasoning_trace.png)
