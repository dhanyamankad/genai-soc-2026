...
Built for **Week 2 of Summer of Code** by [Dhanya Mankad](https://github.com/dhanyamankad).
...
```bash
# 1. Clone the repo
git clone https://github.com/dhanyamankad/week2-docbuddy
cd week2-docbuddy
...
**Question asked:** "What is the capital of France?"
